  ...
  return `
        <tr class="rule-form">
            <td colspan="3">
                ...
                <input type="text" name="url_pattern" style="margin-bottom: 8px;" placeholder="${chrome.i18n.getMessage(
                  'autoSubmitPlaceholderUrl',
                )} site.com">
                <textarea name="code" rows="4" placeholder='${chrome.i18n.getMessage(
...
$('#autosubmit-rules').on('click', '.save-rule', function (e) {
  ...
  try {
    ...
    return alert(chrome.i18n.getMessage('autoSubmitAlertUrlInvalid'));
  }
